...
@interface AccountExplainView()<UIScrollViewDelegate,UITextFieldDelegate>
@end

@implementation AccountExplainView
...
- (void)phoneVertifyView{
    ...
    LoginTextField*phoneNum = [LoginTextField creatLoginTextFieldWithFrame:CGRectMake(70, 0, KScreenWidth-80, 40) Placeholder:@"请输入文字" LeftImageName:@"Mine_icon01" SelectedLeftImageName:@"Mine_icon01"];
